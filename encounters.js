...
const encounters = {
  "inferno": [
    ...
    },
    {
      ...
      "choices": [
        ...
        },
        {
          ...
          "result": "你拆穿了恐惧借用谦卑语气的办法，终于能判断自己究竟是在谨慎，还是在退缩。",
          "effect": {
            "insight": 4
          },
          "school": "reader"
    ...
    },
    {
      ...
      "spoken": "你的手为什么要伤害我？",
      "question": "树枝在你手中流血，里面的人声因疼痛中断。你怎样面对这个由自己的求证造成的伤口？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "布鲁内托不能停，停下会加重刑罚；他请求你边走边谈。你怎样回应这位仍在受罚的旧师？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "他把你认成未来将到的教皇卜尼法斯，意外泄露了另一场买卖圣职。你先纠正什么？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "重力在地心翻转，你以为仍在下降，出口却出现在狭窄岩洞上方。你如何跟上维吉尔？",
      "choices": [
        {
  ...
  "purgatorio": [
    ...
    },
    {
      ...
      "question": "加图的斥责截断歌声，亡魂们突然散开上山。你怎样结束与卡塞拉的重逢？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "贝拉夸拍拍身旁的阴影，邀你坐下；山路还在头顶继续。你要休息、追问，还是先检查自己为何愿意停？",
      "choices": [
        {
          "text": "短暂喘息后按太阳位置继续上升",
    ...
    },
    {
      ...
      "question": "索尔代洛因一个地名便拥抱维吉尔。轮到你开口时，你是否也用城邦来介绍自己？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "门在身后沉重合拢，守门天使早已告诫不要回头。你额上带着七个P，怎样迈出门内第一步？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "海妖要求你继续看着她；你也亲眼看见，正是自己的凝视使她从畸形变得动人。你怎样从梦中脱身？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "斯塔提乌斯赞美维吉尔的诗，却不知道敬爱的诗人就在身旁。维吉尔听见以后，你怎样接住这场错位的相认？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "福雷塞的脸已被饥饿改得难以辨认，但声音仍像你记忆中的旧友。他等你叫出他的名字。",
      "choices": [
        {
  ...
  "paradiso": [
    {
      ...
      "question": "地面正在远离，你却没有感到翅膀或脚步；真正先改变的是目光和欲望的方向。你怎样承受这次上升？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "三面镜子已经摆好：远近不同，反光却同样明亮。你愿意让这个实验推翻刚才关于月斑的直觉吗？",
      "choices": [
        {
    ...
    },
    {
      ...
      "question": "强迫之下的责任与灵魂在月天显现的原因同时困住你。贝雅特丽齐等你先把其中一个问题说清。",
      "choices": [
        {
      ...
      "choices": [
        {
          ...
          "result": "你让忠实接受善恶判断：承诺仍有分量，却不能被拿来替已经造成的新伤害免责。",
          "effect": {
            "will": 3,
            "insight": 2
          },
      ...
      "choices": [
        {
          ...
          "result": "你把宽恕与遗忘分开：库妮扎不再被过去定死，却仍能明确说出哪些行动曾经伤人。",
          "effect": {
            "insight": 4
          },
          "school": "wanderer"
    ...
    },
    {
      ...
      "choices": [
        {
          "text": "问共同真理怎样判断真实的错误",
          "result": "你理解天堂的和谐并非宣布所有思想都一样正确，而是让差异在更大的真理中接受辨别。",
          "effect": {
            "insight": 4
          },
          "school": "wanderer"
        },
        {
          ...
          "result": "西格尔仍以自己的姓名出现；思想分歧没有被胜利者改写成一张没有人物的名单。",
          "effect": {
            "mercy": 4
          },
          "school": "witness"
    ...
    },
    {
      ...
      "choices": [
        ...
        },
        {
          ...
          "result": "你把证据的来源和缺口一并写下，使流传的名声不再冒充一个人的全部历史。",
          "effect": {
            "mercy": 3,
            "insight": 2
          },
      ...
      "choices": [
        {
          ...
          "result": "你把共同声音理解为协调后的判断，而不是让每个成员借集体之名逃掉自己的责任。",
          "effect": {
            "insight": 4
          },
          "school": "wanderer"
      ...
      "choices": [
        {
          ...
          "result": "你承认自己无权宣布永恒结局，却仍保留对眼前行动作出有限伦理判断的责任。",
          "effect": {
            "will": 2,
            "insight": 3
          },
    ...
    },
    {
      ...
      "question": "贝雅特丽齐命令你回头俯看已经越过的七重天和那一点渺小地球。尺度突然改变，你准备怎样看？",
      "choices": [
        {
    ...
    },
    {
      ...
      "choices": [
        ...
        },
        {
          ...
          "result": "你承认光景无法被完整复述，却仍保留贝雅特丽齐的神情、关系和她对你的具体引导。",
          "effect": {
            "mercy": 4
          },
          "school": "witness"
